...
# 2020/05/05
# CV max f1: 0.9362534437478047 /PL 0.879
#
#
...
def train_model():
    ...
    pd.to_pickle(stacking_train, PICKLE_DIR + 'stacking_lightgbm_best_train.pkl')
    pd.to_pickle(stacking_test, PICKLE_DIR + 'stacking_lightgbm_best_test.pkl')
    return model
